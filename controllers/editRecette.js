...
const showEditRecetteController = async (req, res) => {
    
    let sqlSelectRecettes = "SELECT * FROM Recettes WHERE Recettes.id = ?"
    ...
    let sqlSelectRecettesIngredients = "SELECT Ingredients.nom AS ingredients, Ingredients.id AS ingredients_id, Quantites.nom AS quantites, Quantites.id AS quantites_id, Unites.id AS unites_id, Unites.nom AS valeur FROM `Recettes_Ingredients` JOIN Ingredients ON Recettes_Ingredients.ingredients_ID = Ingredients.id JOIN Quantites ON Recettes_Ingredients.quantites_ID = Quantites.id JOIN Unites ON Recettes_Ingredients.unites_ID = Unites.id WHERE Recettes_Ingredients.recettes_ID = ?"
...
const editRecetteController = (req, res) => {
...
export {editRecetteController, showEditRecetteController}