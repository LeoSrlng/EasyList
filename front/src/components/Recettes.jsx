                    ...
                    {filter.includes(item.categories_ID) &&
                        <React.Fragment>
                            ...
                            <article className="recette">
                                <NavLink aria-label="btn-detailRecette" className="btn-recette" to={"/detailsRecette/" + item.id}>
                                    <img alt="image de la recette" className="img-recette" src={`${BASE_IMG}/img_Recettes/${item.image}`}/>
